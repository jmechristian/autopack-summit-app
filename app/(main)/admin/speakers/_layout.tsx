...
export default function AdminSpeakersLayout() {
  ...
  return (
    <Stack>
      <Stack.Screen
        name='index'
        options={{ title: 'Speakers', headerBackVisible: false, headerLeft: adminBackButton }}
      />
      <Stack.Screen
        name='[speakerId]'
        options={{ title: 'Speaker Detail', headerBackVisible: false, headerLeft: adminBackButton }}
      />
    </Stack>
  );
}
